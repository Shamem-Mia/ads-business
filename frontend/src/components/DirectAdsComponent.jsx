...
const DirectAdsComponent = ({ adminPopups = [] }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4">
      ...
      {/* Ads Section */}
      <h2 className="text-xl font-bold text-black text-center mb-4 mt-8">
        Ads
      </h2>
      <DirectAdsShow popups={popups} onPopupClick={handlePopupClick} />
    </div>
  );
};
